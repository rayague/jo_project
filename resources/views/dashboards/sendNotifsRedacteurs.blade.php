...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion " id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center text-light justify-content-center" href="">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Envoyer une notification au redacteur</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <!-- Circle Buttons -->
                                <div class="container text-light rounded my-3 shadow-lg py-3">
                                    <form action="/action_page.php">
                                        <div class="mb-3 mt-3">
                                          <label for="email" class="form-label">Titre de la notif</label>
                                          <input type="email" class="form-control py-4" id="email" placeholder="Pack 5" name="email">
                                        </div>
                                        <div class="mb-3 row=30">
                                          <label for="pwd" class="form-label">Description de la notif</label>
                                          <input type="text" class="form-control py-4" id="pwd" placeholder="Veillez entrer la description de pack" name="pswd">
                                        </div>
                                        <div class="mb-3">
                                            <label for="pwd" class="form-label">Joindre un fichier / image</label>
                                            <input type="file" class="form-control" id="pwd" placeholder="choisissez un fichier" name="pswd">
                                          </div>
                                        <button type="submit" class="btn btn-success col-12 p-3 mt-5">Envoyer</button>
                                    </form>
                                </div>
                            <!-- Brand Buttons -->
